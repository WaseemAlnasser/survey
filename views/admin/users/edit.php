...
<section class="section">
    <form method="post" class="needs-validation was-validated" action="/admin/users/update" novalidate>
        <input type="hidden" name="id" value="<?php echo $user->id ?>">
        <div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Full Name</label>
            <div class="col-md-8 col-lg-9">
                <input name="name" required type="text" class="form-control" id="fullName" value="<?php echo $user->name ?>">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8 col-lg-9">
                <input name="email" required type="email" class="form-control" id="Email" value="<?php echo $user->email ?>">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8 col-lg-9">
                <input name="password_confirmation" type="password" class="form-control" id="password-confirm" placeholder="****" value="">
            </div>
        </div>
